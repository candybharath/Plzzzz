...
PICS = (environ.get('PICS', 'https://graph.org/file/12aa7c75c94d0ecbe5947.jpg')).split()
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+EZFvXS82BFJlNDJl')
MOVIE_GRP = environ.get('MOVIE_GRP', 'https://t.me/Moviezs_Store')
SERIES_GRP = environ.get('SERIES_GRP', 'https://t.me/+EZFvXS82BFJlNDJl')
MAIN_CHNL = environ.get('MAIN_CHNL', 'https://t.me/TamilMovies_Workshop')
MSG_ALRT = environ.get('MSG_ALRT', '🚩 @TamilMovies_Workshop Best Channel In Telegram')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001660274107'))
REQUEST_LOGS = int(environ.get('REQUEST_LOGS', '-1001877931898'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MoviezsStore')
...
CAPTION_BUTTON_URL = "https://t.me/+EZFvXS82BFJlNDJl"
